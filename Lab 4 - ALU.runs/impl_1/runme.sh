...
HD_PWD='D:/Downloads/Downloads/Notes/ENGG 3380/Lab 4 - ALU/Lab 4 - ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_16Bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_16Bit.tcl -notrace
