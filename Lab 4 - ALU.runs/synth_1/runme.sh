...
HD_PWD='D:/Downloads/Downloads/Notes/ENGG 3380/Lab 4 - ALU/Lab 4 - ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_16Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_16Bit.tcl
